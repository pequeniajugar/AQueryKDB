...
.aq.q0:{
 .aq.initQueryState[];
 aq__t0:.aq.initTable[lineitem;"lineitem";0b];
...
.aq.q1:{
 .aq.initQueryState[];
 aq__t0:.aq.initTable[lineitem;"lineitem";0b];
 aq__t0:?[aq__t0;();0b;((`l_orderkey);(`l_partkey);(`l_suppkey);(`l_shipdate);(`l_commitdate))!({x^.aq.cd x} `l_orderkey;{x^.aq.cd x} `l_partkey;{x^.aq.cd x} `l_suppkey;{x^.aq.cd x} `l_shipdate;{x^.aq.cd x} `l_commitdate)];
 aq__t0
 };
.aq.q1[]
