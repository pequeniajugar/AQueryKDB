...
.trg.gen_trg_sync_table2_delete_0:{[tbl;evt;ctx]
 ctx:.trg.ctxSet[ctx;`triggerName;`trg_sync_table2_delete];
 ctx:.trg.ctxSet[ctx;`triggerTable;`table1];
 ctx:.trg.ctxSet[ctx;`triggerEvent;`delete];
 ...
 .trg.register[`table1;`delete;`after;`trg_sync_table2_delete;100;`.trg.gen_trg_sync_table2_delete_0];

{
 .aq.initQueryState[];
 aq__t0:.aq.initTable[table1;"table1";0b];
 
 .aq.deleteRows[`table1;aq__t0;enlist ((=; {x^.aq.cd x} `id; 1))]
 }[];
