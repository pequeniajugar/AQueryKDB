...
DATAPATH:$[(0<count getenv `FINANCIAL_DATAPATH);getenv `FINANCIAL_DATAPATH;"/Users/tianxin/projects/nyu/ms2/independent_study/data/financial/10_5"];
...
/ create random sets required for tests
stock10:neg[10 & count base]?base`Id;
startYear10:first 1?exec distinct TradeDate from price where TradeDate.year <= -1+max TradeDate.year;
...
/maxTradeDateMinus3Years:2017.01.01;
