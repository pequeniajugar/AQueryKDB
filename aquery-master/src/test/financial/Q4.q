...
.aq.q0:{
 ...
 aq__t0:?[aq__t0;((.aq.in;{x^.aq.cd x} `Id;{x^.aq.cd x} `Russell2000);(=; {x^.aq.cd x} `TradeDate; {x^.aq.cd x} `startPeriod));0b;()];
 aq__t0:?[aq__t0;();0b;(enlist[`avg_close_price]!enlist (.aq.avg;{x^.aq.cd x} `ClosePrice))];
 aq__t0
 };
.aq.q0[]
