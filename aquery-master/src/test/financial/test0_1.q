...
.aq.q0:{
 ...
 aq__t1:.aq.sort[aq__t1;((iasc;{x^.aq.cd x} `Id);(iasc;{x^.aq.cd x} `TradeDate));({x^.aq.cd x} `Id;{x^.aq.cd x} `TradeDate;{x^.aq.cd x} `ClosePrice)];
 aq__t1:?[aq__t1;();0b;((`Id);(`TradeDate);(`ClosePrice))!({x^.aq.cd x} `Id;{x^.aq.cd x} `TradeDate;{x^.aq.cd x} `ClosePrice)];
 aq__t1
 };
.aq.q0[]
