...
.aq.q0:{
 ...
 aq__t0:?[aq__t0;enlist ((.aq.in;{x^.aq.cd x} `Id;{x^.aq.cd x} `Russell2000));0b;()];
 aq__t0:?[aq__t0;enlist ((>=; {x^.aq.cd x} `TradeDate; (q9StartDate;())));0b;()];
 aq__t0:?[aq__t0;enlist ((.aq.not;(.aq.in;{x^.aq.cd x} `Id;(q9SplitIds;()))));0b;()];
 aq__t0:?[aq__t0;();(({x^.aq.cd x} `Id);({x^.aq.cd x} `c__0))!({x^.aq.cd x} `Id;(getYear;{x^.aq.cd x} `TradeDate));({x^.aq.cd x} `Id;{x^.aq.cd x} `c__0) _ (.aq.wildCard aq__t0)];
 aq__t0:?[aq__t0;();0b;((`Id);(`c__0);(`c__1))!({x^.aq.cd x} `Id;(getYear';{x^.aq.cd x} `TradeDate);(.aq.avg';{x^.aq.cd x} `ClosePrice))];
 nosplit_avgpx:`Id`year`avg_px xcol aq__t0;
 .aq.initQueryState[];
 aq__t1:.aq.initTable[dividend;"dividend";0b];
 aq__t1:?[aq__t1;enlist ((.aq.in;{x^.aq.cd x} `Id;{x^.aq.cd x} `Russell2000));0b;()];
 aq__t1:?[aq__t1;enlist ((>=; (getYear;{x^.aq.cd x} `AnnounceDate); (q9StartYear;())));0b;()];
 aq__t1:?[aq__t1;enlist ((.aq.not;(.aq.in;{x^.aq.cd x} `Id;(q9SplitIds;()))));0b;()];
 aq__t1:?[aq__t1;();(({x^.aq.cd x} `Id);({x^.aq.cd x} `c__0))!({x^.aq.cd x} `Id;(getYear;{x^.aq.cd x} `AnnounceDate));({x^.aq.cd x} `Id;{x^.aq.cd x} `c__0) _ (.aq.wildCard aq__t1)];
 aq__t1:?[aq__t1;();0b;((`Id);(`c__0);(`c__1))!({x^.aq.cd x} `Id;(getYear';{x^.aq.cd x} `AnnounceDate);(.aq.sum';{x^.aq.cd x} `DivAmt))];
 divdata:`Id`year`total_divs xcol aq__t1;
 .aq.initQueryState[];
 aq__t2:.aq.initTable[nosplit_avgpx;"nosplit_avgpx";1b];
 aq__t3:.aq.initTable[divdata;"divdata";1b];
 aq__t4:.aq.joinUsing[.aq.ej;aq__t2;aq__t3;({x^.aq.cd x} `Id;{x^.aq.cd x} `year)];
 aq__t4:.aq.sort[aq__t4;((iasc;{x^.aq.cd x} `Id);(iasc;{x^.aq.cd x} `year));({x^.aq.cd x} `Id;{x^.aq.cd x} `year;{x^.aq.cd x} `avg_px;{x^.aq.cd x} `total_divs)];
 aq__t4:?[aq__t4;();0b;((`Id);(`year);(`avg_px);(`total_divs);(`yield))!({x^.aq.cd x} `Id;{x^.aq.cd x} `year;(float;{x^.aq.cd x} `avg_px);(float;{x^.aq.cd x} `total_divs);(float;(%; {x^.aq.cd x} `total_divs; {x^.aq.cd x} `avg_px)))];
 aq__t4
 };
.aq.q0[]
