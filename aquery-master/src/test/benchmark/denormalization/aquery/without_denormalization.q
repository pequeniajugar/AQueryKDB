...
.aq.q0:{
 ...
 aq__t6:?[aq__t6;((=; {x^.aq.cd x} `L.l_suppkey; {x^.aq.cd x} `S.s_suppkey);(=; {x^.aq.cd x} `S.s_nationkey; {x^.aq.cd x} `N.n_nationkey);(=; {x^.aq.cd x} `N.n_regionkey; {x^.aq.cd x} `R.r_regionkey);(=; {x^.aq.cd x} `R.r_name; `$"EUROPE"));0b;()];
 aq__t6:?[aq__t6;();0b;((`t.l_orderkey);(`t.l_partkey);(`t.l_suppkey);(`t.l_linenumber);(`t.l_quantity);(`t.l_extendedprice);(`t.l_discount);(`t.l_tax);(`t.l_returnflag);(`t.l_linestatus);(`t.l_shipdate);(`t.l_commitdate);(`t.l_receiptdate);(`t.l_shipinstruct);(`t.l_shipmode);(`t.l_comment);(`t.r_name))!({x^.aq.cd x} `L.l_orderkey;{x^.aq.cd x} `L.l_partkey;{x^.aq.cd x} `L.l_suppkey;{x^.aq.cd x} `L.l_linenumber;{x^.aq.cd x} `L.l_quantity;{x^.aq.cd x} `L.l_extendedprice;{x^.aq.cd x} `L.l_discount;{x^.aq.cd x} `L.l_tax;{x^.aq.cd x} `L.l_returnflag;{x^.aq.cd x} `L.l_linestatus;{x^.aq.cd x} `L.l_shipdate;{x^.aq.cd x} `L.l_commitdate;{x^.aq.cd x} `L.l_receiptdate;{x^.aq.cd x} `L.l_shipinstruct;{x^.aq.cd x} `L.l_shipmode;{x^.aq.cd x} `L.l_comment;{x^.aq.cd x} `R.r_name)];
 aq__t6
 };
.aq.q0[]
