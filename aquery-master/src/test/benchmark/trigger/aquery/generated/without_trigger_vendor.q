...
.aq.q0:{
 .aq.initQueryState[];
 aq__t0:.aq.initTable[orders;"orders";0b];
 aq__t0:?[aq__t0;enlist ((=; {x^.aq.cd x} `vendorid; `$"10"));0b;()];
 aq__t0:?[aq__t0;();0b;(enlist[`amount]!enlist (.aq.sum;(*; {x^.aq.cd x} `quantity; {x^.aq.cd x} `price)))];
 aq__t0
 };
.aq.q0[]
